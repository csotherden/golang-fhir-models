...
// FHIRTypes is documented here http://hl7.org/fhir/ValueSet/fhir-types
type FHIRTypes int

const (
	FHIRTypesBase FHIRTypes = iota
	FHIRTypesElement
...
func (code FHIRTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(code.Code())
}
func (code *FHIRTypes) UnmarshalJSON(json []byte) error {
	s := strings.Trim(string(json), "\"")
	switch s {
	case "Base":
		*code = FHIRTypesBase
	case "Element":
		*code = FHIRTypesElement
	case "BackboneElement":
		*code = FHIRTypesBackboneElement
	case "DataType":
		*code = FHIRTypesDataType
	case "Address":
		*code = FHIRTypesAddress
	case "Annotation":
		*code = FHIRTypesAnnotation
	case "Attachment":
		*code = FHIRTypesAttachment
	case "Availability":
		*code = FHIRTypesAvailability
	case "BackboneType":
		*code = FHIRTypesBackboneType
	case "Dosage":
		*code = FHIRTypesDosage
	case "ElementDefinition":
		*code = FHIRTypesElementDefinition
	case "MarketingStatus":
		*code = FHIRTypesMarketingStatus
	case "ProductShelfLife":
		*code = FHIRTypesProductShelfLife
	case "Timing":
		*code = FHIRTypesTiming
	case "CodeableConcept":
		*code = FHIRTypesCodeableConcept
	case "CodeableReference":
		*code = FHIRTypesCodeableReference
	case "Coding":
		*code = FHIRTypesCoding
	case "ContactDetail":
		*code = FHIRTypesContactDetail
	case "ContactPoint":
		*code = FHIRTypesContactPoint
	case "Contributor":
		*code = FHIRTypesContributor
	case "DataRequirement":
		*code = FHIRTypesDataRequirement
	case "Expression":
		*code = FHIRTypesExpression
	case "ExtendedContactDetail":
		*code = FHIRTypesExtendedContactDetail
	case "Extension":
		*code = FHIRTypesExtension
	case "HumanName":
		*code = FHIRTypesHumanName
	case "Identifier":
		*code = FHIRTypesIdentifier
	case "Meta":
		*code = FHIRTypesMeta
	case "MonetaryComponent":
		*code = FHIRTypesMonetaryComponent
	case "Money":
		*code = FHIRTypesMoney
	case "Narrative":
		*code = FHIRTypesNarrative
	case "ParameterDefinition":
		*code = FHIRTypesParameterDefinition
	case "Period":
		*code = FHIRTypesPeriod
	case "PrimitiveType":
		*code = FHIRTypesPrimitiveType
	case "base64Binary":
		*code = FHIRTypesBase64Binary
	case "boolean":
		*code = FHIRTypesBoolean
	case "date":
		*code = FHIRTypesDate
	case "dateTime":
		*code = FHIRTypesDateTime
	case "decimal":
		*code = FHIRTypesDecimal
	case "instant":
		*code = FHIRTypesInstant
	case "integer":
		*code = FHIRTypesInteger
	case "positiveInt":
		*code = FHIRTypesPositiveInt
	case "unsignedInt":
		*code = FHIRTypesUnsignedInt
	case "integer64":
		*code = FHIRTypesInteger64
	case "string":
		*code = FHIRTypesString
	case "code":
		*code = FHIRTypesCode
	case "id":
		*code = FHIRTypesId
	case "markdown":
		*code = FHIRTypesMarkdown
	case "time":
		*code = FHIRTypesTime
	case "uri":
		*code = FHIRTypesUri
	case "canonical":
		*code = FHIRTypesCanonical
	case "oid":
		*code = FHIRTypesOid
	case "url":
		*code = FHIRTypesUrl
	case "uuid":
		*code = FHIRTypesUuid
	case "Quantity":
		*code = FHIRTypesQuantity
	case "Age":
		*code = FHIRTypesAge
	case "Count":
		*code = FHIRTypesCount
	case "Distance":
		*code = FHIRTypesDistance
	case "Duration":
		*code = FHIRTypesDuration
	case "Range":
		*code = FHIRTypesRange
	case "Ratio":
		*code = FHIRTypesRatio
	case "RatioRange":
		*code = FHIRTypesRatioRange
	case "Reference":
		*code = FHIRTypesReference
	case "RelatedArtifact":
		*code = FHIRTypesRelatedArtifact
	case "SampledData":
		*code = FHIRTypesSampledData
	case "Signature":
		*code = FHIRTypesSignature
	case "TriggerDefinition":
		*code = FHIRTypesTriggerDefinition
	case "UsageContext":
		*code = FHIRTypesUsageContext
	case "VirtualServiceDetail":
		*code = FHIRTypesVirtualServiceDetail
	case "xhtml":
		*code = FHIRTypesXhtml
	case "Resource":
		*code = FHIRTypesResource
	case "Binary":
		*code = FHIRTypesBinary
	case "Bundle":
		*code = FHIRTypesBundle
	case "DomainResource":
		*code = FHIRTypesDomainResource
	case "Account":
		*code = FHIRTypesAccount
	case "ActivityDefinition":
		*code = FHIRTypesActivityDefinition
	case "ActorDefinition":
		*code = FHIRTypesActorDefinition
	case "AdministrableProductDefinition":
		*code = FHIRTypesAdministrableProductDefinition
	case "AdverseEvent":
		*code = FHIRTypesAdverseEvent
	case "AllergyIntolerance":
		*code = FHIRTypesAllergyIntolerance
	case "Appointment":
		*code = FHIRTypesAppointment
	case "AppointmentResponse":
		*code = FHIRTypesAppointmentResponse
	case "ArtifactAssessment":
		*code = FHIRTypesArtifactAssessment
	case "AuditEvent":
		*code = FHIRTypesAuditEvent
	case "Basic":
		*code = FHIRTypesBasic
	case "BiologicallyDerivedProduct":
		*code = FHIRTypesBiologicallyDerivedProduct
	case "BiologicallyDerivedProductDispense":
		*code = FHIRTypesBiologicallyDerivedProductDispense
	case "BodyStructure":
		*code = FHIRTypesBodyStructure
	case "CanonicalResource":
		*code = FHIRTypesCanonicalResource
	case "CapabilityStatement":
		*code = FHIRTypesCapabilityStatement
	case "CarePlan":
		*code = FHIRTypesCarePlan
	case "CareTeam":
		*code = FHIRTypesCareTeam
	case "ChargeItem":
		*code = FHIRTypesChargeItem
	case "ChargeItemDefinition":
		*code = FHIRTypesChargeItemDefinition
	case "Citation":
		*code = FHIRTypesCitation
	case "Claim":
		*code = FHIRTypesClaim
	case "ClaimResponse":
		*code = FHIRTypesClaimResponse
	case "ClinicalImpression":
		*code = FHIRTypesClinicalImpression
	case "ClinicalUseDefinition":
		*code = FHIRTypesClinicalUseDefinition
	case "CodeSystem":
		*code = FHIRTypesCodeSystem
	case "Communication":
		*code = FHIRTypesCommunication
	case "CommunicationRequest":
		*code = FHIRTypesCommunicationRequest
	case "CompartmentDefinition":
		*code = FHIRTypesCompartmentDefinition
	case "Composition":
		*code = FHIRTypesComposition
	case "ConceptMap":
		*code = FHIRTypesConceptMap
	case "Condition":
		*code = FHIRTypesCondition
	case "ConditionDefinition":
		*code = FHIRTypesConditionDefinition
	case "Consent":
		*code = FHIRTypesConsent
	case "Contract":
		*code = FHIRTypesContract
	case "Coverage":
		*code = FHIRTypesCoverage
	case "CoverageEligibilityRequest":
		*code = FHIRTypesCoverageEligibilityRequest
	case "CoverageEligibilityResponse":
		*code = FHIRTypesCoverageEligibilityResponse
	case "DetectedIssue":
		*code = FHIRTypesDetectedIssue
	case "Device":
		*code = FHIRTypesDevice
	case "DeviceAssociation":
		*code = FHIRTypesDeviceAssociation
	case "DeviceDefinition":
		*code = FHIRTypesDeviceDefinition
	case "DeviceDispense":
		*code = FHIRTypesDeviceDispense
	case "DeviceMetric":
		*code = FHIRTypesDeviceMetric
	case "DeviceRequest":
		*code = FHIRTypesDeviceRequest
	case "DeviceUsage":
		*code = FHIRTypesDeviceUsage
	case "DiagnosticReport":
		*code = FHIRTypesDiagnosticReport
	case "DocumentReference":
		*code = FHIRTypesDocumentReference
	case "Encounter":
		*code = FHIRTypesEncounter
	case "EncounterHistory":
		*code = FHIRTypesEncounterHistory
	case "Endpoint":
		*code = FHIRTypesEndpoint
	case "EnrollmentRequest":
		*code = FHIRTypesEnrollmentRequest
	case "EnrollmentResponse":
		*code = FHIRTypesEnrollmentResponse
	case "EpisodeOfCare":
		*code = FHIRTypesEpisodeOfCare
	case "EventDefinition":
		*code = FHIRTypesEventDefinition
	case "Evidence":
		*code = FHIRTypesEvidence
	case "EvidenceReport":
		*code = FHIRTypesEvidenceReport
	case "EvidenceVariable":
		*code = FHIRTypesEvidenceVariable
	case "ExampleScenario":
		*code = FHIRTypesExampleScenario
	case "ExplanationOfBenefit":
		*code = FHIRTypesExplanationOfBenefit
	case "FamilyMemberHistory":
		*code = FHIRTypesFamilyMemberHistory
	case "Flag":
		*code = FHIRTypesFlag
	case "FormularyItem":
		*code = FHIRTypesFormularyItem
	case "GenomicStudy":
		*code = FHIRTypesGenomicStudy
	case "Goal":
		*code = FHIRTypesGoal
	case "GraphDefinition":
		*code = FHIRTypesGraphDefinition
	case "Group":
		*code = FHIRTypesGroup
	case "GuidanceResponse":
		*code = FHIRTypesGuidanceResponse
	case "HealthcareService":
		*code = FHIRTypesHealthcareService
	case "ImagingSelection":
		*code = FHIRTypesImagingSelection
	case "ImagingStudy":
		*code = FHIRTypesImagingStudy
	case "Immunization":
		*code = FHIRTypesImmunization
	case "ImmunizationEvaluation":
		*code = FHIRTypesImmunizationEvaluation
	case "ImmunizationRecommendation":
		*code = FHIRTypesImmunizationRecommendation
	case "ImplementationGuide":
		*code = FHIRTypesImplementationGuide
	case "Ingredient":
		*code = FHIRTypesIngredient
	case "InsurancePlan":
		*code = FHIRTypesInsurancePlan
	case "InventoryItem":
		*code = FHIRTypesInventoryItem
	case "InventoryReport":
		*code = FHIRTypesInventoryReport
	case "Invoice":
		*code = FHIRTypesInvoice
	case "Library":
		*code = FHIRTypesLibrary
	case "Linkage":
		*code = FHIRTypesLinkage
	case "List":
		*code = FHIRTypesList
	case "Location":
		*code = FHIRTypesLocation
	case "ManufacturedItemDefinition":
		*code = FHIRTypesManufacturedItemDefinition
	case "Measure":
		*code = FHIRTypesMeasure
	case "MeasureReport":
		*code = FHIRTypesMeasureReport
	case "Medication":
		*code = FHIRTypesMedication
	case "MedicationAdministration":
		*code = FHIRTypesMedicationAdministration
	case "MedicationDispense":
		*code = FHIRTypesMedicationDispense
	case "MedicationKnowledge":
		*code = FHIRTypesMedicationKnowledge
	case "MedicationRequest":
		*code = FHIRTypesMedicationRequest
	case "MedicationStatement":
		*code = FHIRTypesMedicationStatement
	case "MedicinalProductDefinition":
		*code = FHIRTypesMedicinalProductDefinition
	case "MessageDefinition":
		*code = FHIRTypesMessageDefinition
	case "MessageHeader":
		*code = FHIRTypesMessageHeader
	case "MetadataResource":
		*code = FHIRTypesMetadataResource
	case "MolecularSequence":
		*code = FHIRTypesMolecularSequence
	case "NamingSystem":
		*code = FHIRTypesNamingSystem
	case "NutritionIntake":
		*code = FHIRTypesNutritionIntake
	case "NutritionOrder":
		*code = FHIRTypesNutritionOrder
	case "NutritionProduct":
		*code = FHIRTypesNutritionProduct
	case "Observation":
		*code = FHIRTypesObservation
	case "ObservationDefinition":
		*code = FHIRTypesObservationDefinition
	case "OperationDefinition":
		*code = FHIRTypesOperationDefinition
	case "OperationOutcome":
		*code = FHIRTypesOperationOutcome
	case "Organization":
		*code = FHIRTypesOrganization
	case "OrganizationAffiliation":
		*code = FHIRTypesOrganizationAffiliation
	case "PackagedProductDefinition":
		*code = FHIRTypesPackagedProductDefinition
	case "Patient":
		*code = FHIRTypesPatient
	case "PaymentNotice":
		*code = FHIRTypesPaymentNotice
	case "PaymentReconciliation":
		*code = FHIRTypesPaymentReconciliation
	case "Permission":
		*code = FHIRTypesPermission
	case "Person":
		*code = FHIRTypesPerson
	case "PlanDefinition":
		*code = FHIRTypesPlanDefinition
	case "Practitioner":
		*code = FHIRTypesPractitioner
	case "PractitionerRole":
		*code = FHIRTypesPractitionerRole
	case "Procedure":
		*code = FHIRTypesProcedure
	case "Provenance":
		*code = FHIRTypesProvenance
	case "Questionnaire":
		*code = FHIRTypesQuestionnaire
	case "QuestionnaireResponse":
		*code = FHIRTypesQuestionnaireResponse
	case "RegulatedAuthorization":
		*code = FHIRTypesRegulatedAuthorization
	case "RelatedPerson":
		*code = FHIRTypesRelatedPerson
	case "RequestOrchestration":
		*code = FHIRTypesRequestOrchestration
	case "Requirements":
		*code = FHIRTypesRequirements
	case "ResearchStudy":
		*code = FHIRTypesResearchStudy
	case "ResearchSubject":
		*code = FHIRTypesResearchSubject
	case "RiskAssessment":
		*code = FHIRTypesRiskAssessment
	case "Schedule":
		*code = FHIRTypesSchedule
	case "SearchParameter":
		*code = FHIRTypesSearchParameter
	case "ServiceRequest":
		*code = FHIRTypesServiceRequest
	case "Slot":
		*code = FHIRTypesSlot
	case "Specimen":
		*code = FHIRTypesSpecimen
	case "SpecimenDefinition":
		*code = FHIRTypesSpecimenDefinition
	case "StructureDefinition":
		*code = FHIRTypesStructureDefinition
	case "StructureMap":
		*code = FHIRTypesStructureMap
	case "Subscription":
		*code = FHIRTypesSubscription
	case "SubscriptionStatus":
		*code = FHIRTypesSubscriptionStatus
	case "SubscriptionTopic":
		*code = FHIRTypesSubscriptionTopic
	case "Substance":
		*code = FHIRTypesSubstance
	case "SubstanceDefinition":
		*code = FHIRTypesSubstanceDefinition
	case "SubstanceNucleicAcid":
		*code = FHIRTypesSubstanceNucleicAcid
	case "SubstancePolymer":
		*code = FHIRTypesSubstancePolymer
	case "SubstanceProtein":
		*code = FHIRTypesSubstanceProtein
	case "SubstanceReferenceInformation":
		*code = FHIRTypesSubstanceReferenceInformation
	case "SubstanceSourceMaterial":
		*code = FHIRTypesSubstanceSourceMaterial
	case "SupplyDelivery":
		*code = FHIRTypesSupplyDelivery
	case "SupplyRequest":
		*code = FHIRTypesSupplyRequest
	case "Task":
		*code = FHIRTypesTask
	case "TerminologyCapabilities":
		*code = FHIRTypesTerminologyCapabilities
	case "TestPlan":
		*code = FHIRTypesTestPlan
	case "TestReport":
		*code = FHIRTypesTestReport
	case "TestScript":
		*code = FHIRTypesTestScript
	case "Transport":
		*code = FHIRTypesTransport
	case "ValueSet":
		*code = FHIRTypesValueSet
	case "VerificationResult":
		*code = FHIRTypesVerificationResult
	case "VisionPrescription":
		*code = FHIRTypesVisionPrescription
	case "Parameters":
		*code = FHIRTypesParameters
	default:
		return fmt.Errorf("unknown FHIRTypes code `%s`", s)
	}
	return nil
}
func (code FHIRTypes) String() string {
	return code.Code()
}
func (code FHIRTypes) Code() string {
	switch code {
	case FHIRTypesBase:
		return "Base"
...
func (code FHIRTypes) Display() string {
	switch code {
	case FHIRTypesBase:
		return "Base"
	case FHIRTypesElement:
...
func (code FHIRTypes) Definition() string {
	switch code {
	case FHIRTypesBase:
