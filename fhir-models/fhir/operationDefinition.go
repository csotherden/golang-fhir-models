...
type OperationDefinitionParameter struct {
	...
	Scope             []OperationParameterScope                    `bson:"scope,omitempty" json:"scope,omitempty"`
	Min               int                                          `bson:"min" json:"min"`
	Max               string                                       `bson:"max" json:"max"`
	Documentation     *string                                      `bson:"documentation,omitempty" json:"documentation,omitempty"`
	Type              *FHIRTypes                                   `bson:"type,omitempty" json:"type,omitempty"`
	AllowedType       []FHIRTypes                                  `bson:"allowedType,omitempty" json:"allowedType,omitempty"`
