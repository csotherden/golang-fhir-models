...
// MetadataResource is documented here http://hl7.org/fhir/StructureDefinition/MetadataResource
...
func UnmarshalMetadataResource(b []byte) (MetadataResource, error) {
	...
	if err := json.Unmarshal(b, &metadataResource); err != nil {
		return metadataResource, err
	}
	return metadataResource, nil
}
