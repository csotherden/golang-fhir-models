...
type ElementDefinition struct {
	...
	DefaultValueInteger64             *json.Number                  `bson:"defaultValueInteger64,omitempty" json:"defaultValueInteger64,omitempty"`
	...
	FixedInteger64                    *json.Number                  `bson:"fixedInteger64,omitempty" json:"fixedInteger64,omitempty"`
	...
	PatternInteger64                  *json.Number                  `bson:"patternInteger64,omitempty" json:"patternInteger64,omitempty"`
	...
	MinValueInteger64                 *json.Number                  `bson:"minValueInteger64,omitempty" json:"minValueInteger64,omitempty"`
	...
	MaxValueInteger64                 *json.Number                  `bson:"maxValueInteger64,omitempty" json:"maxValueInteger64,omitempty"`
