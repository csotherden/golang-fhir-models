...
type Observation struct {
	...
	InstantiatesReference *Reference                  `bson:"instantiatesReference,omitempty" json:"instantiatesReference,omitempty"`
...
type ObservationTriggeredBy struct {
	...
	Extension         []Extension     `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension     `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Observation       Reference       `bson:"observation" json:"observation"`
	Type              TriggeredBytype `bson:"type" json:"type"`
