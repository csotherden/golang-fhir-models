...
type SubscriptionStatus struct {
	...
	EventsSinceSubscriptionStart *json.Number                          `bson:"eventsSinceSubscriptionStart,omitempty" json:"eventsSinceSubscriptionStart,omitempty"`
...
type SubscriptionStatusNotificationEvent struct {
	...
	Extension         []Extension `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	EventNumber       json.Number `bson:"eventNumber" json:"eventNumber"`
