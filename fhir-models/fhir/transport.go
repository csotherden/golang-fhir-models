...
// Transport is documented here http://hl7.org/fhir/StructureDefinition/Transport
type Transport struct {
	...
	Status                *TransportStatus      `bson:"status,omitempty" json:"status,omitempty"`
	...
	CompletionTime        *string               `bson:"completionTime,omitempty" json:"completionTime,omitempty"`
	...
	RequestedLocation     Reference             `bson:"requestedLocation" json:"requestedLocation"`
	CurrentLocation       Reference             `bson:"currentLocation" json:"currentLocation"`
	Reason                *CodeableReference    `bson:"reason,omitempty" json:"reason,omitempty"`
	History               *Reference            `bson:"history,omitempty" json:"history,omitempty"`
}
...
type TransportInput struct {
	...
	ValueInteger64             json.Number           `bson:"valueInteger64" json:"valueInteger64"`
	...
	ValueRatioRange            RatioRange            `bson:"valueRatioRange" json:"valueRatioRange"`
...
// MarshalJSON marshals the given Transport as JSON into a byte slice
